...
final class Jobs
{
    ...
    {
        return $this->dispatcher->get('/admin/merchant/v1/jobs', $query);
    }
    ...
    {
        return $this->dispatcher->get('/admin/merchant/v1/jobs/detail', [
            'job_id' => $jobId,
        ]);
    }
    ...
    {
        return $this->dispatcher->post('/admin/merchant/v1/jobs/cancel', $payload);
    }
}
